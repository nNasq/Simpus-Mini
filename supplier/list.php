...
$daftarSupplier = $pdo->query("SELECT * FROM supplier ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
        ...
        <div class="row mb-4">
            <div class="col-md-6 col-lg-4">
                <div class="input-group shadow-sm">
                    ...
                    <input type="text" id="search-input" class="form-control border-start-0 ps-0" placeholder="Ketik nama supplier..." aria-describedby="search-icon">
                </div>
            </div>
        </div>
